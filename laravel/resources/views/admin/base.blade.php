            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <img src='{{ asset("uploads/admin")}}/m_{{session('adminuser')->icon}}' class="user-image" alt="User Image"/>


                  <span class="hidden-xs">{{session("adminuser")->nick_name}}</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="pull-left image">
              ...
              <img src='{{ asset("uploads/admin")}}/m_{{session('adminuser')->icon}}' class="img-circle" alt="User Image" />

            </div>
            <div class="pull-left info">
              <p>{{session("adminuser")->nick_name}}</p>
          ...
          <ul class="sidebar-menu">
            ...
            <li class=" treeview">
              <a href="#">
                <i class="glyphicon glyphicon-user"></i> <span>会员管理</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li class="active"><a href="{{url('admin/op_member_detail')}}"><i class="fa fa-circle-o"></i> 浏览信息</a></li>
              ...
              <li class=" treeview">
                <a href="#">
                  <i class="glyphicon glyphicon-user"></i> <span>管理员管理</span> <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                  <li class="active"><a href="{{url('admin/op_admin')}}"><i class="fa fa-circle-o"></i> 浏览信息</a></li>
                  <li><a href="{{url('admin/op_admin/create')}}"><i class="fa fa-circle-o"></i> 添加信息</a></li>
                </ul>
              </li>
              <li class=" treeview">
                <a href="#">
                  <i class="glyphicon glyphicon-user"></i> <span>板块管理</span> <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                  <li class="active"><a href="{{url('admin/op_tab')}}"><i class="fa fa-circle-o"></i> 浏览板块</a></li>
                  <li><a href="{{url('admin/op_tab/create')}}"><i class="fa fa-circle-o"></i> 添加板块</a></li>
                </ul>
              </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="{{url('admin/type')}}"><i class="fa fa-circle-o"></i> 商品分类列表</a></li>
                <li><a href="{{url('admin/type/create')}}"><i class="fa fa-circle-o"></i> 添加商品分类</a></li>
                <li><a href="{{url('admin/good')}}"><i class="fa fa-circle-o"></i> 商品列表</a></li>
              ...
              <li class="treeview">
                <a href="#">
                  <i class="fa fa-camera"></i> <span>轮播图管理</span> <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                  <li class="active"><a href="{{url('admin/op_carousel')}}"><i class="fa fa-circle-o"></i> 浏览信息</a></li>
                  <li><a href="{{url('admin/op_carousel/create')}}"><i class="fa fa-circle-o"></i> 添加信息</a></li>
                </ul>
              </li>
              ...
              <li class="treeview">
                <a href="#">
                  ...
                  <i class="fa fa-dashboard"></i> <span>商品评论管理</span> <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                  <li class="active"><a href="{{url("admin/comment")}}"><i class="fa fa-circle-o"></i> 浏览评价信息</a></li>
                  <li><a href="{{url('admin/comment/create')}}"><i class="fa fa-circle-o"></i> 评论回收站</a></li>
                </ul>
              </li>
              <li class="treeview">
                <a href="#">
              
                  <i class="glyphicon glyphicon-th-list"></i> <span>订单管理</span> <i class="fa fa-angle-left pull-right"></i>

                </a>
                <ul class="treeview-menu">
                  <li class="active"><a href="{{url('admin/order')}}"><i class="fa fa-circle-o"></i> 浏览订单信息</a></li>
                  <li class="active"><a href="{{url('admin/order/create')}}"><i class="fa fa-circle-o"></i> 订单回收站</a></li>
                 
                </ul>
              </li>
              <li class="treeview">
                <a href="#">
                  <i class="fa fa-glass"></i> <span>收货人地址管理</span> <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                  <li class="active"><a href="{{url('admin/address')}}"><i class="fa fa-circle-o"></i> 地址信息浏览</a></li>
                  
                </ul>
              </li>
              <li class="treeview">
                <a href="#">
                  <i class="fa fa-cog"></i> <span>网站配置管理</span> <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                  <li class="active"><a href="{{url('admin/config')}}"><i class="fa fa-circle-o"></i> 浏览信息</a></li>
                  <li><a href="{{url('admin/config/create')}}"><i class="fa fa-circle-o"></i> 添加信息</a></li>
                </ul>
              </li>
              <li class="treeview">
                <a href="#">
                  <i class="fa fa-heart"></i> <span>友情链接管理</span> <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                  <li class="active"><a href="{{url('admin/link')}}"><i class="fa fa-circle-o"></i> 浏览友情链接</a></li>
